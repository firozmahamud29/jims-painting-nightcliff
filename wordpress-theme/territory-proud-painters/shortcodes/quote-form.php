<?php
/**
 * Shortcode: [tpp_quote_form]
 * Renders the 2-step lead form ("Territory Earth" v3 design).
 *
...
function tpp_quote_form_shortcode( $atts = array() ) {
        ...
        <form id="leadForm" method="post" novalidate>
            ...
            <div class="fstep active" data-step="1">
                ...
                <div class="grid-2">
                    ...
                    <div><label class="lbl" for="suburb">Suburb</label><input type="text" id="suburb" name="suburb" placeholder="Palmerston" required></div>
                </div>
                <div class="grid-2">
            ...
            <div class="fstep" data-step="2">
                ...
                <?php wp_nonce_field( 'tpp_lead_nonce', 'tpp_nonce_field' ); ?>
                <div class="factions">
            ...
            <div class="fsuccess" aria-live="polite">
                <svg width="52" height="52" viewBox="0 0 52 52" aria-hidden="true"><circle cx="26" cy="26" r="24" stroke="#2C3A2E" stroke-width="2" fill="#EDE4D3"/><path d="M16 27l7 7 14-14" stroke="#2C3A2E" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
add_shortcode( 'tpp_quote_form', 'tpp_quote_form_shortcode' );
