/* ============================================================
   TERRITORY PROUD PAINTERS — WP Theme JS ("Territory Earth" v3)
...
(function () {
  ...
  function initForm() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      data.source = 'Territory Proud Painters — Website';
      ...
      try {
        const res = await fetch(TPP.ajax_url, {
          method: 'POST',
          headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
          body: new URLSearchParams({ action: 'tpp_submit_lead', payload: JSON.stringify(data), nonce: TPP.nonce })
        });
