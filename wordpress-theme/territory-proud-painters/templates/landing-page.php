<?php
/**
 * Pre-built "Territory Earth" landing page — WP template part.
...
<section class="hero" id="quote">
  <div class="wrap hero-grid">
    ...
    <?php echo do_shortcode( '[tpp_quote_form]' ); ?>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="ba-slider reveal" id="baSlider">
      <div class="ba-img ba-after" data-label="After · Ludmilla, 2025">
        <div class="ba-fill illus" style="background:linear-gradient(135deg,#C0552E 0%,#EDE4D3 100%);"></div>
  ...
  <div class="wrap">
    ...
    <div class="pkg-row">
      <article class="pkg reveal">
        ...
        <a href="#quote" class="btn btn-outline btn-block">Get a quote</a>
      </article>
      <article class="pkg pkg-featured reveal">
        ...
        <a href="#quote" class="btn btn-primary btn-block">Get my free quote</a>
      </article>
      <article class="pkg reveal">
...
<section class="why">
  <div class="wrap">
    <div class="section-head reveal">
      <span class="eyebrow">06 — Why Territory Proud</span>
      <h2>Built for Top End <em>conditions.</em></h2>
    </div>
    <div class="bento">
      <div class="bento-cell bento-lg reveal">
        <h3>Paints that survive the Wet</h3>
        <p>UV-stable, low-VOC, mould-resistant coatings engineered for 90%+ dry-season humidity and cyclone-season storms. We don't use mainland formulations — we use what actually lasts in the Territory.</p>
      ...
      <div class="bento-cell bento-md reveal">
        <h3>Locally owned. Territory proud.</h3>
...
<section class="gallery">
  <div class="wrap">
    ...
    <div class="gallery-bento">
      <figure class="gtile gtile-tall reveal"><div class="photo-illus" style="background:linear-gradient(160deg,#C0552E,#EDE4D3);"><span>Exterior · Stuart Park</span></div></figure>
      <figure class="gtile reveal"><div class="photo-illus" style="background:linear-gradient(160deg,#2C3A2E,#5A7060);"><span>Interior · Parap</span></div></figure>
      <figure class="gtile reveal"><div class="photo-illus" style="background:linear-gradient(160deg,#C8923B,#F6F1E7);"><span>Feature Wall · Bayview</span></div></figure>
      <figure class="gtile gtile-wide reveal"><div class="photo-illus" style="background:linear-gradient(160deg,#1F1A17,#4A3F38);"><span>Commercial · Darwin CBD</span></div></figure>
      <figure class="gtile reveal"><div class="photo-illus" style="background:linear-gradient(160deg,#C0552E,#8B3A1F);"><span>Roof · Leanyer</span></div></figure>
      <figure class="gtile reveal"><div class="photo-illus" style="background:linear-gradient(160deg,#5A7060,#2C3A2E);"><span>Deck &amp; Fence · Humpty Doo</span></div></figure>
    </div>
  </div>
</section>
...
<section class="final-cta">
  <div class="wrap narrow center reveal">
    ...
    <a href="#quote" class="btn btn-primary btn-lg magnetic" data-magnetic>Get my free quote <span>→</span></a>
