...
Tags: elementor, business, lead-generation, painting-contractor, franchise, rtl-language-support
...
* Mobile floating CTA, scroll-to-top, scroll-spy nav, FAQ accordion
...
3. Upload this theme: Appearance → Themes → Add New → Upload Theme
   → choose jims-painting-nightcliff.zip → Install → Activate.
...
Appearance → Customize → JPN — Contact Details
to set phone, email, address, social links, and lead recipient email.

== Shortcodes ==

[jpn_quote_form]  →  renders the 2-step lead form anywhere.
...
= 1.0.0 =
* Initial release — Jim's Painting Nightcliff franchisee build.
